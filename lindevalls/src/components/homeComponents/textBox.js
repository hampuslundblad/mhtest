    ...
    <Styles>
      <div className="textbox-wrapper d-flex">
        <div className="descText-container col-md-5">
          ...
          <div className="button-container">
            <ul className="list-unstyled">
              <li>
                <LindButtonArrow btntext="Gå till VVS" routeTo="/about" />
              </li>
              <li>
                <LindButtonArrow btntext="Gå till service" routeTo="/about" />
              </li>
              <li>
                <LindButtonArrow
                  btntext="Gå till värmepumpar"
                  routeTo="/about"
                />
              </li>
            </ul>
        ...
        <div className="img-container col-md-8">
          <img src={image} alt="Bild på Hamus bil"></img>
        </div>
      </div>
    </Styles>
  );
